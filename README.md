...
<p align="center">
  <img src="https://img.shields.io/badge/version-v3.5.0-58a6ff?style=flat" alt="v3.5.0">
...
For OpenCode, paste this one-line install prompt into your agent. This URL is pinned to the immutable `v3.4.1` release instructions:
